...
RcppExport SEXP _RcppConcaveman_cpp_concaveman(SEXP xSEXP, SEXP ySEXP, SEXP concavitySEXP, SEXP lengthThresholdSEXP, SEXP chullSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_RcppConcaveman_cpp_concaveman", (DL_FUNC) &_RcppConcaveman_cpp_concaveman, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_RcppConcaveman(DllInfo *dll) {
